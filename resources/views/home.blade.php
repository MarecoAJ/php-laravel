...
@section('content')
    <div class="bg-gray-900 px20 py-16 rounded-lg mb-8 relative overflow-hidden">
        ...
        <img src="{{ asset('images/dev.png') }}" class="absolute -right-20 top-0 opacity-20">
    </div>
    <div class="px-4">
        ...
        <div class="grid grid-cols-1 gap-4 mb-4">
            @foreach ( $posts as $post)
                <a href="{{ route('post', $post->slug) }}" class="bg-gray-100 rounded-lg px-6 py-4">
                    <p class="txt-xs flex items-center gap-2">
                    ...
                    <div class="text-xs text-gray-900 opacity-75 flex itens-center gap-1">
